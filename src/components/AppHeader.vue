  ...
  <div class="dropdown-menu" :class="{ show: isMenuOpen }">
    ...
    <ul>
      <li @click="toggleSubMenu1">
        <router-link to="" :class="{ show: isSubMenuOpen[1] }"
          >쿠킹</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[1] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[0]}?crtPage=1`"
              >한식</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[1]}?crtPage=1`"
              >일식</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[2]}?crtPage=1`"
              >중식</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[3]}?crtPage=1`"
              >양식</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu2">
        <router-link to="" :class="{ show: isSubMenuOpen[2] }"
          >베이킹</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[2] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[4]}?crtPage=1`"
              >제과</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[5]}?crtPage=1`"
              >제빵</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[6]}?crtPage=1`"
              >쇼콜라</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[7]}?crtPage=1`"
              >디저트</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu3">
        <router-link to="" :class="{ show: isSubMenuOpen[3] }"
          >음료</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[3] }">
          ...
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[9]}?crtPage=1`"
              >바리스타</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu4">
        <router-link to="" :class="{ show: isSubMenuOpen[4] }"
          >뷰티</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[4] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[10]}?crtPage=1`"
              >네일</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[11]}?crtPage=1`"
              >미용</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[12]}?crtPage=1`"
              >메이크업</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[13]}?crtPage=1`"
              >패션</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu5">
        <router-link to="" :class="{ show: isSubMenuOpen[5] }"
          >공예</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[5] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[14]}?crtPage=1`"
              >비즈</router-link
            >
          </li>
          <li>
          ...
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[16]}?crtPage=1`"
              >자수</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[17]}?crtPage=1`"
              >도자기</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[18]}?crtPage=1`"
              >터프팅</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu6">
        <router-link to="" :class="{ show: isSubMenuOpen[6] }"
          >스포츠</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[6] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[19]}?crtPage=1`"
              >수영</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[20]}?crtPage=1`"
              >축구</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[21]}?crtPage=1`"
              >야구</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[22]}?crtPage=1`"
              >배구</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[23]}?crtPage=1`"
              >골프</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[24]}?crtPage=1`"
              >볼링</router-link
            >
          </li>
        </ul>
      ...
      <li @click="toggleSubMenu7">
        <router-link to="" :class="{ show: isSubMenuOpen[7] }"
          >심리/상담</router-link
        >
        <ul class="subMenuList" :class="{ show: isSubMenuOpen[7] }">
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[25]}?crtPage=1`"
              >부부상담</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[26]}?crtPage=1`"
              >가정상담</router-link
            >
          </li>
          <li>
            <router-link
              :to="`/searchresultpage2/${this.subCateNo[27]}?crtPage=1`"
              >심리상담</router-link
            >
          </li>
        </ul>
      ...
      <li>
        <router-link :to="`/searchresultpage2/${this.subCateNo[28]}?crtPage=1`"
          >IT</router-link
        >
      </li>
    </ul>
  ...
  <header>
      ...
      <div class="inner">
        ...
        <ul>
          ...
          <li
            ...
            "
          >
            <router-link to="/login/user">로그인</router-link>
          </li>
          <li v-else>
    ...
    <div class="inner">
      <div class="bottom">
        <div
          class="hamberger"
          @mouseover="cateMouseover"
          @mouseleave="cateMouseleave"
          @click="toggleMenu"
        >
          <img :src="cateSrc" alt="" />
          <p>카테고리</p>
        ...
        <ul>
          <li>
            <router-link to="/wishlistclass" @click="checkAuth" class="like"
              >위시리스트</router-link
            >
          </li>
          <li>
            <router-link to="/mypage/pay" @click="checkAuth" class="my"
              >마이</router-link
            >
          </li>
        </ul>
...
export default {
  ...
  methods: {
    find() {
      //
      const url = `/classlist/1?keyword=${encodeURIComponent(this.keyword)}`;
      window.location.href = url; // 페이지를 새로고침하며 이동s
    },
    /////////////////////////////// ss /////////////////////////////////////
    // 로그아웃
    logout() {
