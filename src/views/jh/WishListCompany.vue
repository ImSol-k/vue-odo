            ...
            <div class="wishlistCompanyBox" v-for="(a, i) in b" :key="i">
              <div>
                <div class="whsilistImg wishlistCompanyImg">
                  <img v-if="a.companyImage != null" class="" v-bind:src="require(`@/assets/images/company/${a.companyImage}.png`)" alt="" @click="goCompanyInfo" />
                  <img v-else class="" src="../../assets/images/company/이미지없음.png" alt="" @click="goCompanyInfo" />
                  <img v-on:click.prevent="modalUp" style="cursor: pointer"
