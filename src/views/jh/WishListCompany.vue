            ...
            <div class="wishlistCompanyBox" v-for="(a, i) in b" :key="i">
              <div>
                <div class="whsilistImg wishlistCompanyImg">
                  <img v-if="a.companyImage != null" class="" v-bind:src="`${this.$store.state.apiBaseUrl}/upload/${a.companyImage}`" alt="" @click="goCompanyInfo" />
                  <img v-else class="" v-bind:src="`${this.$store.state.apiBaseUrl}/upload/noneImage.jpg`" alt="" @click="goCompanyInfo" />
