    ...
    <div class="companyJoinTitleJ">
      ...
      <div class="companyJoinInfo">
        <div>
          ...
          <input type="text" name="" id="businesNumber" v-model="companyVo.companyBn" placeholder="사업자번호" disabled />
        ...
        <div>
          ...
          <input type="text" name="" id="companyId" v-model="companyVo.companyId" placeholder="아이디" disabled />
        </div>
        <div>
          <!-- <label for="companyPass">비밀번호</label> -->
          <input type="password" name="" id="companyPass" placeholder="비밀번호 변경" v-model="companyPassChack" minlength="8"
            maxlength="16" />
          <p>비밀번호를 입력해주세요.(8~16글자)</p>
        </div>
        <div>
          <!-- <label for="companyPassChack">비밀번호확인</label> -->
          <input type="password" name="" id="companyPassChack" placeholder="비밀번호 확인" v-model="companyVo.companyPass" />
        ...
        <div>
          <!-- <label for="companyPassChack">비밀번호확인</label> -->
          <input type="text" name="" id="companyPassChack2" placeholder="대표 핸드폰번호" v-model="companyVo.companyHp" />
        </div>
      </div>
