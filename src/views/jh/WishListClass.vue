<template>
      ...
      <div class="mymy-content">
        ...
        <div class="mymy-main clearfix">
          ...
          <!--
                    ...
                    -->
          <div class="wishlistClassBox">
            <!--위시리스트 있을때-->
            <div class="wishClassBox" v-for="(a, i) in b" :key="i">
              <div class="whsilistImg">
                <img class="" v-bind:src="`../../assets/images/class/${ a.classImage }.jpg`" alt="" @click="goDetailPage" />
                <img v-on:click.prevent="modalUp" style="cursor: pointer" class=""
              ...
              <div class="wishClassContent">
                <p class="">서울/강남</p>
                <p class="">도자기 만들기 일일클래스</p>
                <p class="">
                  내가만든 도자기 굽기 마무리까지! 일일클래스입니다
                </p>
                <p class="">무료</p>
              </div>
            </div>
  ...
  <div id="newModal">
    <div class="modal-content2">
      ...
      <div class="modal-b">
        <button>취소</button>
        <button v-on:click="close">삭제</button>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    listup() {
      axios({
        ...
        console.log(this.b);
        console.log(this.b[0].classImage);
      }).catch(error => {
        console.log(error);
      });
    }
